...
export default function Component() {
  return (
    <div className="fixed inset-0 -z-10 bg-slate-950">
      {/* Radial spotlight (banana yellow) */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_800px_at_50%_200px,#facc15,transparent)]" />
      {/* Secondary spotlight (amber) */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_600px_at_80%_50%,#f59e0b,transparent)] opacity-40" />
      {/* Grain overlay */}
